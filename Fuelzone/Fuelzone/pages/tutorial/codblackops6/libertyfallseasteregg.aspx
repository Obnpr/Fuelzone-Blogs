<%@ Title="Liberty Falls Easter Egg Guide" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="libertyfallseasteregg.aspx.cs" Inherits="Fuelzone.pages.tutorial.codblackops6.libertyfallseasteregg" %>
...
<asp:Content ID="BodyContent" ContentPlaceHolderID="MainContent" runat="server">
    <main class="container mt-4" aria-labelledby="title">
        ...
        <section class="row mb-4">
            <div class="col-12">
                <div class="custom-bg text-white p-4">
                    <h2>Liberty Falls - Easter Egg Full Walkthrough Guide</h2>
                    <hr>
        ...
        <section class="row mb-4">
            <div class="col-12">
                <div class="p-4 night-mode-bg" style="background: transparent;">
                    ...
                    <div class="col-12">
                        <div class="bg-light p-4 night-mode-bg">
                            ...
                            <h3>Guide Content</h3>
                            <p>
                                Sometimes, we gamers need a little reminder to step away from the screen and get some fresh air. Valorant is an intense game, and taking a break is often the key to keeping your aim sharp and your mind clear. In this guide, you'll learn:
                            </p>
                            <ul>
                                ...
                                <li>Tips for Valorant players to maximize their break time.</li>
                            </ul>
                            ...
                            <h4>Call of Duty: Black Ops 6 Zombies - Liberty Falls Guide</h4>
                            <p>
                            ...
                            <h4>#Building the Thrustodyne M23 – BO6 Zombies#</h4>
                            <p>
                            ...
                            <h5>#Activate the machine at the Church#</h5>
                            <p>
                            ...
                            <h5>#How to get the Handbrake#</h5>
                            <p>
                            ...
                            <h5>#How to get the Water Pressure Valve#</h5>
                            <p>
                            ...
                            <p>
                                Take the water valve to the Bowling Alley, and on the wall to the left of the counter, smash the panel on the wall and you’ll need to interact with it and hold the button down while the Water Pressure increases. This is much easier if you have a teammate protect you. When the Water Pressure reaches the maximum, you’ll be able to pick up the Water Pressure Gauge.
                            </p>

                            <h5>#How to get the Electrical Wires#</h5>
                            <p>
                            ...
                            <h5>#How to find the Thrustodyne M23 Workbench#</h5>
                            <p>
                            ...
                            <p>
                                #First LTG part location# The first part is within the Church, hovering over the left side of the balcony.
                            </p>
                            <p>
                                #Second LTG part location# For the second part, head down the hill towards the flower shop but climb on top of the building with the Speed Cola in front, and then hop onto the white truck in the road.
                            </p>
                            <p>
                                You will be able to suck a part for the LTG out of the open upper window of the building to the left of the Speed Cola.
                            </p>
                            <p>
                                #Third LTG part location# Finally, the third LTG part is located in the ceiling of the comic store. Stand in the middle of the counter and aim up to see it.
                            </p>

                            <h5>#How to find the LTG Workbench#</h5>
                            <p>
                            ...
                            <h5>#Capturing a monster - Step 2#</h5>
                            <p>
                            ...
                            <h5>#Activating the Strauss machines - Step 3#</h5>
                            <p>
                            ...
                            <ul>
                                <li>LOW = Red light</li>
                                <li>MEDIUM = Yellow light</li>
                                <li>HIGH = Green light</li>
                            </ul>
                            <p>You can change the light on top of the machine by interacting with it. Here are the locations for each machine:</p>

                            <h5>#First Strauss machine location#</h5>
                            <p>
                            ...
                            <h5>#Second Strauss machine location#</h5>
                            <p>
                                In the back garden of the house with the Toolshed from earlier, near the long stairs.
                            </p>

                            <h5>#Third Strauss machine location#</h5>
                            <p>
                                From the bank rooftop, you can "buy" a door, which detonates a wooden board. Jump from there to find the final machine in the corner overlooking the motel.
                            </p>

                            <h5>#Acquire the Aether Canister#</h5>
                            <p>
                            ...
                            <h5>#Capturing a monster round 2 - Step 4#</h5>
                            <p>
                            ...
                            <h5>#Finish the fight, completing the Liberty Falls story - Step 5, Last Step#</h5>
                            <p>
