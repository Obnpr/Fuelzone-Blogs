<%@ Page Title="Basic Building Techniques" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="false" CodeBehind="BasicBuildingTechniques.aspx.cs" Inherits="Fuelzone.Contact" %>
        ...
        <section class="row mb-4">
            <div class="col-12">
                <div class="bg-light p-4 night-mode-bg">
                    ...
                    <ul>
                        <li>Start by building a floor (platform) to give you a base.</li>
                        <li>Next, build four walls around you to protect yourself.</li>
                        <li>Then, place a ramp inside the walls to gain elevation.</li>
                        <li>Finally, place a roof above you to complete the tower and block incoming shots.</li>
                    </ul>
                    ...
                    <ul>
                        <li>Build a ramp towards your target or position.</li>
                        <li>Place walls in front of the ramp to protect yourself from enemy fire.</li>
                        <li>Continue placing ramps and walls as you advance forward, ensuring your safety while closing the distance.</li>
                    </ul>
                    ...
                    <ul>
                        <li>Place four walls around you, enclosing yourself in a box.</li>
                        <li>Add a floor and roof to complete the structure, creating a fully enclosed space.</li>
                        <li>If you're under fire, edit a window or door to peek and return shots while maintaining cover.</li>
                    </ul>
                    ...
                    <ul>
                        <li>Start by placing walls in front of you to block incoming shots.</li>
                        <li>Place a ramp behind you to give you the high ground and protect yourself from above.</li>
                        <li>Continue to build additional walls and ramps around you to create a quick fortress.</li>
                    </ul>
                    ...
                    <ul>
                        <li>Build a ramp to climb up to a higher position.</li>
                        <li>Place a platform or floor above you to give yourself more building space.</li>
                        <li>If needed, build additional ramps to reach even higher ground or create platforms for mobility.</li>
                    </ul>
